...
namespace Imperial_Commander_Editor
{
	...
	/// </summary>
	public partial class CrateProps : UserControl, IPropertyModel, INotifyPropertyChanged
	{
		string _ownerName;
		...
		private void TextBox_KeyDown( object sender, System.Windows.Input.KeyEventArgs e )
		{
			if ( e.Key == System.Windows.Input.Key.Enter )
			{
				...
				(DataContext as Crate).entityProperties.name = (DataContext as Crate).name;
			}
		}

		private void ownerChangeBtn_Click( object sender, System.Windows.RoutedEventArgs e )
		{
			((sender as FrameworkElement).DataContext as Crate).mapSectionOwner = Utils.mainWindow.activeSection.GUID;
